...
// ============================================================================
// SWITCH BETWEEN DHANUR VIDYA / SRI VIDYA TABS
// ============================================================================
function switchVidyaTab(tabName) {
  // Hide all vidya contents
  document.querySelectorAll(".vidya-tab-content").forEach((tab) => {
    tab.style.display = "none";
    tab.classList.remove("active");
  });

  // Deactivate all vidya tab buttons
  document.querySelectorAll(".vidya-tab-btn").forEach((btn) => {
    btn.classList.remove("active");
  });

  // Show selected content
  const tabId = `vidya-${tabName}`;
  ...
  // Activate selected button based on text match
  const buttons = document.querySelectorAll(".vidya-tab-btn");
  buttons.forEach((btn) => {
    if (
      (tabName === "dhanur" && btn.textContent.includes("Dhanur")) ||
      (tabName === "sri" && btn.textContent.includes("Sri Vidya")) ||
      (tabName === "connection" && btn.textContent.includes("Connection"))
    ) {
...
window.switchVidyaTab = switchVidyaTab;
